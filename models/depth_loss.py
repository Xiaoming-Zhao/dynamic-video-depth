# Modified from https://github.com/google/mannequinchallenge/blob/cb5b773a49c38e533989026ef46596aea142133b/models/networks.py
...
class JointLoss(nn.Module):
    ...
    def LaplacianSmoothnessLoss(self, depth, img):
        # Eq. (16) of https://arxiv.org/pdf/1712.00175.pdf
    ...
    def GradientLoss(self, log_prediction_d, mask, log_gt):
        # Eq. (3) of https://arxiv.org/pdf/1804.00607.pdf
    ...
    def Data_Loss(self, log_prediction_d, mask, log_gt):
        # Eq. (3) of https://arxiv.org/pdf/1406.2283.pdf
    ...
    def forward(self, input_images, pred_d_0, targets, use_sm_loss=True):

        log_pred_d_0 = torch.log(pred_d_0)
        ...
        # https://github.com/google/mannequinchallenge/blob/cb5b773a49c38e533989026ef46596aea142133b/loaders/image_folder.py#L263
        ...
        d_gt_0 = torch.clamp(d_gt_0, 0.01)
        ...
        # print('\ndata_term %f' % data_term.item(), torch.sum(log_d_gt_0))
